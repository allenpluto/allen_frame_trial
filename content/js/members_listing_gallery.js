...
$('.members_organization_gallery_wrapper').on('click',function(event){
    ...
    {
        $(this).find('.members_organization_gallery_container').removeClass('members_organization_gallery_container_active');
