...
console.log(status);
    ...
    $('#form_members_account_street_address_place_id').val(place['place_id']);
...
function initialMap(map_center, map_zoom, map_mapTypeId)
{
    ...
    if (!map)
    {
        map = new google.maps.Map(document.getElementById("form_members_account_street_address_map"), mapOptions);
...
function resetMap()
{
    ...
    $('#form_members_account_street_address').val('');
    $('#form_members_account_street_address_place_id').val('');
...
function initialize_autocomplete()
{
    autocomplete = new google.maps.places.Autocomplete(
        /** @type {!HTMLInputElement} */(document.getElementById('form_members_account_street_address')),
    ...
    $('#form_members_account_street_address_place_id').trigger('change');
}

$('#form_members_account_street_address_place_id').change(function(){
