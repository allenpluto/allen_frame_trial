...
--
-- Table structure for table `tbl_entity_account_log`
--

CREATE TABLE IF NOT EXISTS `tbl_entity_account_log` (
  ...
  `remote_ip` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
