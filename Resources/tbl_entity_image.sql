...
--
-- Host: localhost
-- Generation Time: Jul 19, 2017 at 03:02 PM
...
CREATE TABLE IF NOT EXISTS `tbl_entity_image` (
  ...
  `source_file` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=387494 ;
